                      ...
                      <div className="product-ctr">
                        <div className="product-inf">
                          <span className="product-inf__title">
                            <ul>
                              <li>
                                Developed a complex application that
                                incorporates search functionality and
                                bookmarking based upon MVC architecture.
                              </li>
                              <li>
                                {" "}
                              ...
                              <li>
                                {" "}
                                Built an MVC architecture and utilized modules
                                for code organization and optimization.
                              </li>
                              <li>
                                {" "}
                                Integrated features such as recipe searching,
                                bookmarking, and custom recipe creation which
                          ...
                          <span className="product-inf__title">
                            <ul>
                              <li>
                                ...
                                using React.js, Router,React Context, and
                          ...
                          <span className="product-inf__title">
                            <ul>
                              ...
                              <li>
                                ...
                                application using React, Next.js, and
                                TypeScript.
                              </li>
                              <li>
