    ...
    <div className="container">
      <div className="title-box">
        ...
        <p>
          ...
          Tailwind CSS. I've built applications ranging from a notes web app to
          interactive games like chess and tic-tac-toe. Additionally, I've
          tackled larger-scale projects like the Mapty project and the Forkify
          project. These experiences have allowed me to hone my problem-solving
          skills and develop a strong eye for detail. Working on projects like a
          bank app has taught me to prioritize security and scalability in my
          code. Overall, I am always eager to take on new challenges and
